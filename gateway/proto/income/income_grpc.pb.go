...
type TransactionServiceClient interface {
	...
	GetReport(ctx context.Context, in *IncomeEmpty, opts ...grpc.CallOption) (*ReportResponseIncome, error)
}
...
func (c *transactionServiceClient) GetReport(ctx context.Context, in *IncomeEmpty, opts ...grpc.CallOption) (*ReportResponseIncome, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ReportResponseIncome)
...
type TransactionServiceServer interface {
	...
	GetReport(context.Context, *IncomeEmpty) (*ReportResponseIncome, error)
...
func (UnimplementedTransactionServiceServer) GetReport(context.Context, *IncomeEmpty) (*ReportResponseIncome, error) {
...
func _TransactionService_GetReport_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TransactionServiceServer).GetReport(ctx, req.(*IncomeEmpty))
	}
	return interceptor(ctx, in, info, handler)
}
